...
public final class IgnisService {
    ...
    public func getID(for address: EthereumAddress) throws -> BigUInt {
        ...
        do {
            ...
            let tx = try wallet.prepareReadContractTx(contractABI: ignisABI, contractAddress: ignisAddress, contractMethod: "ethereumAddressToAccountID", gasLimit: .automatic, gasPrice: .automatic, parameters: [address] as [AnyObject], extraData: Data())
