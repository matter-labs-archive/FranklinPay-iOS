...
//import BigInt
//
//class PayForCheque: BasicViewController {
//
...
//    }
//
//    init(cheque: BuffiCode, credit: Bool) {
//        self.cheque = cheque
//        self.credit = credit
...
//        do {
//            let contact = try contactsService.getContact(address: cheque.targetAddress)
//            return contact.name
//        } catch {
//            return nil
//        }
...
//
//    func setupContact() {
//        self.amountLabel.text = String((cheque.count ?? BigUInt(1))  * (cheque.price ?? BigUInt(0))) + " $"
//        let name = self.isContactExists(address: self.cheque.targetAddress) ?? "Unknown contact"
//        self.contactName.text = name
//        self.contactAddress.text = self.cheque.targetAddress.address
//        let blockies = Blockies(seed: cheque.targetAddress.address, size: 5, scale: 4, color: Colors.mainGreen, bgColor: Colors.mostLightGray, spotColor: Colors.mainBlue)
...
//            self.titleLabel.text = self.credit ? "You will pay with credit!" : nil
//            self.processAnimation.alpha = 0
//            self.successIcon.alpha = 0
//            self.topButton.alpha = 0
//            self.bottomButton.alpha = 1
//            self.bottomButton.setTitle("Pay", for: .normal)
...
////                guard let chequeAmount = Double(cheque.) else {return}
...
//            self.processAnimation.alpha = 0
//            self.topButton.alpha = self.isContactExists(address: self.cheque.targetAddress) != nil ? 0 : 1
//            self.bottomButton.alpha = 1
...
//            return
//        }
//        let contact = Contact(address: cheque.targetAddress.address, name: name)
//        do {
...
//}
//
//extension PayForCheque: UITextFieldDelegate {
//
//}
