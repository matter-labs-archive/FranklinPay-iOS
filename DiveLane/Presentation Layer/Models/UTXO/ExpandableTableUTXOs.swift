...
extension TableUTXO: Equatable {
    static func ==(lhs: TableUTXO, rhs: TableUTXO) -> Bool {
        let equalUTXOs = lhs.utxo.blockNumber == rhs.utxo.blockNumber && lhs.utxo.outputNumber == rhs.utxo.outputNumber && lhs.utxo.transactionNumber == rhs.utxo.transactionNumber && lhs.utxo.value == rhs.utxo.value
        return equalUTXOs &&
